...
<body topmargin="0" <?php body_class(); ?>>
    <div id="wrapper">
	    ...
	    <div id="btn">
			...
			<img src="<?php echo(bloginfo('template_directory').'/pic/top/'.$strLanguage.'02_1.png');?>" alt="マンション">
			...
			<a href="http://jafnet.co.jp/wordpress/?page_id=208<?php echo $strPathLang;?>" class="top_btn"><img src="<?php echo(bloginfo('template_directory').'/pic/top/'.$strLanguage.'06_0.png');?>"></a>
		...
		<div id="container">
			...
			<label for="tab-1"><?php echo TOKYO_AREA;?></label>
			<div class="empty">&nbsp;</div>
			<!--Pestaña 2 inactiva por defecto-->
			<input id="tab-2" type="radio" name="tab-group">
			<label for="tab-2"><?php echo METROPOLIS_AREA;?></label>
			<div class="empty">&nbsp;</div>
			<!--Pestaña 3 inactiva por defecto-->
			<input id="tab-3" type="radio" name="tab-group">
			<label for="tab-3"><?php echo OTHER_AREAS;?></label>
			<hr class="blue_bar">
			...
			<div id="content">
				...
				<div id="content-1">
					...
					<?php if ( have_posts() ) : ?>
	 					<section>
	 						<?php $objPosts = new WP_Query(array('posts_per_page' => '100', 'category__and' => array( 3, 6 ))); //Tokyo?>
				...
				<div id="content-2">
					<?php if ( have_posts() ) : ?>
	 					<section>
	 						<?php $objPosts = new WP_Query(array('posts_per_page' => '100', 'category__and' => array( 4, 6 ))); //Metropolis?>
	 						<?php while ($objPosts->have_posts() ) : $objPosts->the_post(); ?>
					    		<article class="<?php post_class();?>">
					    			<?php the_content(); ?>
					    		</article>
				...
				<div id="content-3">
					<?php if ( have_posts() ) : ?>
	 					<section>
	 						<?php $objPosts = new WP_Query(array('posts_per_page' => '100', 'category__and' => array( 5, 6 ))); //Other?>
	 						<?php while ($objPosts->have_posts() ) : $objPosts->the_post(); ?>
					    		<article class="<?php post_class();?>">
					    			<?php the_content(); ?>
					    		</article>
