...
<body topmargin="0" <?php body_class(); ?>>
    <div id="wrapper">
	    ...
	    <div id="btn">
			...
			<img src="<?php echo(bloginfo('template_directory').'/pic/top/'.$strLanguage.'07_1.png');?>" alt="会社概要">
	    </div>
	  	<div id="slideshow">
		...
		<div id="container">
			...
			<label for="tab-1" style="width: 256px; text-align: left;">&nbsp;<?php echo ABOUT_US; ?></label>
			<div class="empty">&nbsp;</div>
			<hr class="blue_bar">
			<div id="content" style="height: 740px;">
				<div id="content-1">

					<table class="table_inside" border="0">
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_NAME?></td>
							<td class="about_right"><?php echo NAME_CONTENT?></td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_HEADQUARTERS?></td>
							<td class="about_right">
								<p><?php echo HEADQUARTERS_CONTENT?>  <img alt="J&F Plaza" src="<?php bloginfo('template_directory');?>/pic/content/maps_logo_b.png"></p>
								<p>03 6455 0360</p>
							</td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_BRANCH?></td>
							<td class="about_right">
								<p><?php echo BRANCH_CONTENT?> <img alt="J&F Plaza" src="<?php bloginfo('template_directory');?>/pic/content/maps_logo_b.png"></p>
								<p>048 299 6065</p>
							</td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left">FAX</td>
							<td class="about_right">03 6455 0361</td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left">URL</td>
							<td class="about_right">http://www.jafplaza.com</td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left">E-MAIL</td>
							<td class="about_right">info@jafplaza.com</td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_ESTABLISHED?></td>
							<td class="about_right"><?php echo ESTABLISHED_CONTENT?></td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_CAPITAL?></td>
							<td class="about_right"><?php echo CAPITAL_CONTENT?></td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_PRESIDENT?></td>
							<td class="about_right"><?php echo PRESIDENT_CONTENT?></td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_EMPLOYEES?></td>
							<td class="about_right"><?php echo EMPLOYEES_CONTENT?></td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_SERVICES?></td>
							<td class="about_right">
								<?php echo SERVICES_CONTENT?>
							</td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_AFFILIATES?></td>
							<td class="about_right">
								<?php echo AFFILIATES_CONTENT?>
							</td>
						</tr>
						<tr class="tr_inside">
							<td class="about_left"><?php echo ABOUT_BANKS?></td>
							<td class="about_right">
					...
					<br>
				  	<div id="footer-container" class="footer-container">
					  	<div id="footer" class="footer">
					  		...
					  		<p><?php echo ABOUT_ADDRESS?> <img alt="J&F Plaza" src="<?php bloginfo('template_directory');?>/pic/footer/maps_logo.png"></p><p>TEL: (+81) 03-6455-0360    FAX: (+81) 03-6455-0360</p><p>Copyright (C) 2001 J&F Plaza Co., Ltd. All Rights Reserved.</p>
					  	</div>
				  	</div>
				</div>
			</div>
