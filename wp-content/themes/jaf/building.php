...
<body topmargin="0" <?php body_class(); ?>>
    <div id="wrapper">
	    ...
	    <div id="btn">
			...
			<img src="<?php echo(bloginfo('template_directory').'/pic/top/'.$strLanguage.'04_1.png');?>" alt="ビル">
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="content-1">
					...
					<?php if ( have_posts() ) : ?>
	 					<section>
	 						<?php $objPosts = new WP_Query(array('posts_per_page' => '100', 'category__and' => array( 3, 9 ))); //Tokyo?>
				...
				<div id="content-2">
					<?php if ( have_posts() ) : ?>
	 					<section>
	 						<?php $objPosts = new WP_Query(array('posts_per_page' => '100', 'category__and' => array( 4, 9 ))); //Metropolis?>
	 						<?php while ($objPosts->have_posts() ) : $objPosts->the_post(); ?>
					    		<article class="<?php post_class();?>">
					    			<?php the_content(); ?>
					    		</article>
				...
				<div id="content-3">
					<?php if ( have_posts() ) : ?>
	 					<section>
	 						<?php $objPosts = new WP_Query(array('posts_per_page' => '100', 'category__and' => array( 5, 9 ))); //Other?>
	 						<?php while ($objPosts->have_posts() ) : $objPosts->the_post(); ?>
					    		<article class="<?php post_class();?>">
					    			<?php the_content(); ?>
					    		</article>
